# Export van projects_data_sharing_2023.json
...
### samenvatting
VIVET is een Nederlands programma dat vraaggestuurd data ontwikkelt, bundelt en/of verbetert om het datafundament voor de energietransitie te versterken (met nadruk op gebouwde omgeving en hernieuwbare energie op land). Gestart als 3‑jarig programma in 2019 en in 2021 structureel gemaakt.
...
## id: mffbas
naam: MFFBAS (Marktfaciliteringsforum & Beheerder Afsprakenstelsel)
status: Actief
scope: Energiedomein
geografische_scope: Nederland
eigenaar: MFF (vereniging) & BAS B.V. – sectorbrede governance (o.a. Netbeheer Nederland, Energie‑Nederland, VMNed, Techniek Nederland)
jaar_start: 2019
jaar_einde: None
...
### samenvatting
Nieuwe governance en afsprakenstelsel voor de toegang tot en uitwisseling van gereguleerde energiedata. De sector zette vanaf 2019 stappen; het Afsprakenstelsel is sinds 1 april 2022 in werking. Focus ligt o.a. op het delen van slimme‑meterdata onder regie van de consument, met waarborging van privacy.
...
### samenvatting
Samenwerkingsplatform (o.a. regionale netbeheerders, TenneT en GTS) dat de Nederlandse energiemarkt faciliteert met robuuste ketenprocessen en IT‑infrastructuur voor veilige gegevensuitwisseling. Opgericht op 6 juli 2001 als ECH; in 2007 als EDSN verdergegaan.
...
### samenvatting
Nationaal programma dat 30 regio’s ondersteunt bij het maken en uitvoeren van hun Regionale Energiestrategie (RES) voor o.a. grootschalige duurzame elektriciteit op land en duurzame warmtebronnen. De RES‑aanpak vraagt intensief gebruik en uitwisseling van ruimtelijke, energie- en omgevingsdata.
...
### samenvatting
Demonstratieproject (Duitsland) dat het International Data Spaces (IDS) concept toepast op energiedata. Toont hoe data‑soevereiniteit en veilige datadeling kan werken in een keten, bijvoorbeeld bij waterstofproductie (windturbine ↔ elektrolyser).
...
### samenvatting
EU‑project dat een referentiearchitectuur voor het energiesysteem ontwikkelt (gebaseerd op SGAM), aangesloten bij IDSA-, FIWARE- en GAIA‑X‑principes. Ontwikkelt IDSA‑compliant componenten voor toepassing in 7 pilots en 11 use cases, inclusief een (monetair en niet‑monetair) compensatiesysteem rond het delen van energiedata.
...
### samenvatting
EU‑project dat een gedecentraliseerde, gedistribueerde, open‑source data space ontwikkelt om energiedata in Europa te delen. Ontwikkelt o.a. een administratieve interface die kan koppelen aan home‑automation en slimme meters zodat gebruikers ‘in‑house’ consent kunnen beheren voor het delen van hun slimme‑meterdata.
...
### samenvatting
EU‑project dat een energy data space ontwikkelt ter ondersteuning van local energy communities (LEC’s). Focus op eenvoudige onboarding, integratie met andere EU data spaces en tooling/diensten voor LEC‑stakeholders. Verwachte resultaten: ontologie, IT‑referentiearchitectuur en een blockchain‑gebaseerde marktplaats. Validatie in 9 cases.
...
### samenvatting
EU‑project dat een stakeholder‑inclusieve referentie‑implementatie van een data space voor energiedata ontwikkelt. Integreert gegevens van consumenten, energienetwerken, gebouwen en mobiliteit en maakt collectieve‑intelligentiebenaderingen mogelijk. Getoetst op 3 demo‑locaties in 3 landen.
...
### samenvatting
EU‑project dat een Open Data Management Tool ontwikkelde om databeheer en toegankelijkheid in energieonderzoek te verbeteren voor energie‑industrie en toezichthouders. Biedt een gebruiksvriendelijk digitaal platform en is gebaseerd op FAIR‑principes.
...
### samenvatting
EU‑project dat werkt aan het Interoperability Network for the Energy Transition (int:net): een cross‑domain community die interoperabele energie‑services ontwikkelt met stakeholders uit energie‑relevante domeinen.
...
geografische_scope: Nederland
eigenaar: Coalitie van (o.a.) Nederlandse publieke en private organisaties; community >60 organisaties/initiatieven
jaar_start: 2020
jaar_einde: None
...
### korte_referentie.primair_doel
Cross‑sectoraal datadelen versnellen en interoperabiliteit tussen data spaces versterken, met regie bij de rechthebbende.
